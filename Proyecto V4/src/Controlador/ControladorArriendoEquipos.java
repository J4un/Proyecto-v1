...
public class ControladorArriendoEquipos implements Serializable{
    ...
    public void llenarControlador (){
        try {
            ...
            creaImplemento(1010,"Patines",1000);
            creaImplemento(1011,"Moto de nieve",30000);
            long codArriendo = ControladorArriendoEquipos.getInstancia().creaArriendo("001");//CREA ARRIENDO
            System.out.println(ControladorArriendoEquipos.getInstancia().agregaEquipoToArriendo(0, 1010));
            cierraArriendo(0);
            ...
            pagaArriendoContado(0, 99);
            pagaArriendoContado(0, 100);

        }catch (ClienteException | EquipoException |ArriendoException e) {
            System.out.println(e.getMessage()+"POR QUE NO SE LLENAAAAAAAAAAAAAAAAA MATENME");
    }
    }
